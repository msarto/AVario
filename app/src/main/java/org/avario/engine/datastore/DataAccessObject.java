...
public class DataAccessObject {
	...
	public double getSensitivity() {
		double dynamicSensitivity = Math.max(5.0, Preferences.baro_sensitivity  - gForce * 2.0);
		return Double.isNaN(dynamicSensitivity) || dynamicSensitivity > 50 ? 50f : dynamicSensitivity;
	}
	...
	public double getQFE() {
		return refAltitude < 0 ? 0.0 : (getLastAltitude() - refAltitude);
	}
