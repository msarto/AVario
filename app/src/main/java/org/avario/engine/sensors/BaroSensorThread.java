...
import org.avario.utils.filters.impl.BufferFilter;
...
public class BaroSensorThread extends SensorThread<Float> {
    ...
    private BaroSensorFilter baroFilter = new BaroSensorFilter(new BufferFilter(0.02f), new Kalman2Filter(), new StabiloFilter());
