...
package org.avario.inappbilling.util;
...
public class Inventory {
	protected Map<String, SkuDetails> mSkuMap = new HashMap<String, SkuDetails>();
	protected Map<String, Purchase> mPurchaseMap = new HashMap<String, Purchase>();
